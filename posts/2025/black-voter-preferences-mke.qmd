---
title: "The Decline in Support for Democratic Candidates among Black Milwaukeeans is Easily Exaggerated"
author: "John Johnson"
date: "August 27, 2025"
---
...
```{r, echo=FALSE}
knitr::include_graphics("graphics/pres-gov-by-ward-majority.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("graphics/black-hispanic-coefficient-change.png")
```
